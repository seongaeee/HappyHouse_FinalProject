    ...
    <section id="field">
      <div>
        ...
        <b-row>
          <b-col col="4"></b-col>
          <b-col col="4">
            <div id="personal-score" v-if="value != null" style="margin-top: 15%">
              ...
              <h3 class="mt-4" v-if="parkScore != null">
                공원 : {{ parkScore.toFixed(2) }} / {{ ratio.toFixed(2) }}
              </h3>
              ...
              <h3 class="mt-4" v-if="stationScore != null">
                지하철 {{ stationScore.toFixed(2) }} / {{ ratio.toFixed(2) }}
              </h3>
