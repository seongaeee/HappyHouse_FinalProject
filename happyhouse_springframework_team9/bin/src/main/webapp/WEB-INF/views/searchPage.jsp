            ...
            <div class="col-6">
                ...
                <TABLE BORDER=1 CELLSPACING=1 CELLPADDING=1>
					<TR>
						...
						<th width=100 bgcolor=#113366><font color=#ffffee size=2>위도</font></th>
						<th width=100 bgcolor=#113366><font color=#ffffee size=2>경도</font></th>
						<th width=100 bgcolor=#113366><font color=#ffffee size=2>이미지</font></th>
			                	<c:forEach items="${list}" var="h">
									<tr bgcolor=pink>
										...
										<a href="deepSearch?aptName=${h.aptName }">${h.aptName }</a></font>
                ...
                <a href="/deepSearch" class="btn btn-block btn-lg btn-primary">매물 상세보기</a>
            </div>
